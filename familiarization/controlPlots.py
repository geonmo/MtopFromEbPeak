...
# Open the file
fiData = TFile.Open(" /wk3/cmsdas/store/user/cmsdas/2016/LONG_EXERCISES/MtopFromEbPeak/Data13TeV_MuonEG_2015D_v4.root", "READ")
# Get the tree
...
# Open the file
fiMC = TFile.Open(" /wk3/cmsdas/store/user/cmsdas/2016/LONG_EXERCISES/MtopFromEbPeak/MC13TeV_TTJets.root", "READ")
# Get the tree
